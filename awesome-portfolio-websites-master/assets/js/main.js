...
<div class="nav-wrapper">
    <a href="#!" class="brand-logo"><img src="assets/images/skill-page/signature.png"></a>
...
<footer class="webintern-footer">
    <div class="footer-left">
      ...
      <a href="https://www.linkedin.com/in/ajay-dhage-88aab9164" class="linkedin sub-footer-icon">
          <i class="fab fa-linkedin"></i>
        </a>
        <a href="https://github.com/githubajaydhage" class="git sub-footer-icon">
          <i class="fab fa-github"></i>
        </a>
        <a href="https://twitter.com/thegenuineguy2" class="twitter sub-footer-icon">
          <i class="fab fa-twitter"></i>
        </a>
        <a href="mail-to:dhageajay008@gmail.com" class="email-icon sub-footer-icon" >
        ...
        <a href="#" class="dribbble sub-footer-icon">
            ...
            <a href="https://www.instagram.com/_ajay_dhage_/" class="instagram sub-footer-icon">
